...
public class SightingViewActivity extends AppCompatActivity {
        ...
        tabs.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            public void onTabChanged(String tabId) {
                ...
                if (i == 0) {
                    ...
                    System.out.println("entre en al pestaña");
    ...
    private void getInfo() {
        ...
        TextView lLocation = (TextView) findViewById(R.id.sighting_location_label);
        lLocation.setText("Longitud:");
        TextView tLocation = (TextView) findViewById(R.id.sighting_location);
        tLocation.setText(sighting.getLocation().getName());
...
//            tType.setTextAppearance(R.style.computerIcon);
    ...
    private void getPictures(){
        ...
        System.out.println("UEEEP" + sighting.getPictures());
        System.out.println("UEEEP " + sighting.getContact());
        System.out.println("UEEEP " + sighting.getId());
        System.out.println("UEEEP " + sighting.getType());
    ...
    private void addItemList(final List<Picture> pictures) {
        sighting.setPictures(pictures);
        Picture pic = pictures.get(0);
            System.out.println(pic.getFile());
            try {
                ImageView imageInfo = (ImageView)findViewById(R.id.sighting_picture);
                Bitmap bitmap = BitmapFactory.decodeStream((InputStream) new URL(pic.getFile()).getContent());
